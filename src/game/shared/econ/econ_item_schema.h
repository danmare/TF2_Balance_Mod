...
public:
	...
	bool		IsCustomItem(void) const			{ return m_bCustomItem; } //OO//
...
public:
	...
	typedef CUtlMap<int, CEconItemDefinition*, int>	CustomItemDefinitionMap_t; //OO//
	const CustomItemDefinitionMap_t& GetCustomItemDefinitionMap() const { return m_mapCustomItems; } //OO//
...
private:
	...
	CustomItemDefinitionMap_t							m_mapCustomItems; //OO//
